  ...
  <header class="site-header">
    <div class="container">
      ...
      <div class="site-header__menu group">
        ...
        <!-- Below code is to add dynamic menu through wordpress -->
          <!-- <?php 
          ...
          ?>           -->
            ...
            echo "class='current-menu-item'"; ?>><a href="<?php echo site_url('programs'); ?>">Programs</a></li>
            <li <?php if(get_post_type() == 'event' || is_page('past-events')) 
            echo "class='current-menu-item'"; ?>><a href="<?php echo site_url('events'); ?>">Events</a></li>
            <li <?php if(get_post_type() == 'campus') 
            echo "class='current-menu-item'"; ?>><a href="<?php echo get_post_type_archive_link('campus'); ?>">Campuses</a></li>
